--[[
    Dwarf Fortress Viral/Tomb Transformation Script (Lua)
    Generates "Epicenter" and "Minion" resurrection interactions for VESSEL creatures.
    
    Logic Update:
    1. Generates a unique "Raise Servant" interaction for every VESSEL creature.
    2. Generates a unique "Tomb/Disturbance" interaction for every VESSEL creature.
    3. The Creature created by the Tomb (the Epicenter) is granted the ability to raise 
       ITSELF and EVERY OTHER VESSEL of the same archetype.
]]--

local ENABLE_LOGGING = true
local ENABLE_RAW_LOGGING = false

-- [[ CONFIGURATION: Allowed Archetypes ]] --
