...
local SOURCE_MAP = {
    ...
    },
    {
        ...
        tokens = [[
	[PROFESSION_NAME:RECRUIT:hyperpredator:hyperpredators]
	[PROFESSION_NAME:WRESTLER:hyperpredator:hyperpredators]
	[PROFESSION_NAME:MASTER_WRESTLER:hyperpredator:hyperpredators]
]]
    },
