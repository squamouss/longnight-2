...
local VARIANT_POOLS = {
    BIOMACHINE = {
        DEVIL = {
            ...
            TTN = {
                { token = "[MEGABEAST]", weight = 50, log_name = "DEVIL MEGABEAST" },
        ...
        OGRE = {
            ...
            TTN = {
                { token = "[MEGABEAST]", weight = 20, log_name = "OGRE MEGABEAST" },
    ...
    HOLOMACHINE = {
        HYBRID = {
            GNT = {
                { token = "[SEMIMEGABEAST]", weight = 100, log_name = "HYBRID SEMIMEGABEAST" }
            },
            TTN = {
                { token = "[MEGABEAST]", weight = 50, log_name = "HYBRID MEGABEAST" },
                { token = "[FEATURE_BEAST]", weight = 50, log_name = "HYBRID FORGOTTENBEAST" }
            }
        },
        GLITCH = {
            GNT = {
                { token = "[SEMIMEGABEAST]", weight = 100, log_name = "GLITCH SEMIMEGABEAST" }
            },
            TTN = {
                { token = "[MEGABEAST]", weight = 20, log_name = "GLITCH MEGABEAST" },
                { token = "[FEATURE_BEAST]", weight = 80, log_name = "GLITCH FORGOTTENBEAST" }
            }
        }
    },
    DEMIMACHINE = {
        MECHA = {
            GNT = {
                { token = "[SEMIMEGABEAST]", weight = 100, log_name = "MECHA SEMIMEGABEAST" }
            },
            TTN = {
                { token = "[MEGABEAST]", weight = 50, log_name = "MECHA MEGABEAST" },
                { token = "[FEATURE_BEAST]", weight = 50, log_name = "MECHA FORGOTTENBEAST" }
            }
        },
        SWARM = {
            GNT = {
                { token = "[SEMIMEGABEAST]", weight = 100, log_name = "SWARM SEMIMEGABEAST" }
            },
            TTN = {
                { token = "[MEGABEAST]", weight = 20, log_name = "SWARM MEGABEAST" },
                { token = "[FEATURE_BEAST]", weight = 80, log_name = "SWARM FORGOTTENBEAST" }
            }
        }
    },
    CYBERMACHINE = {
        SCRAP = {
            GNT = {
                { token = "[SEMIMEGABEAST]", weight = 100, log_name = "SCRAP SEMIMEGABEAST" }
            },
            TTN = {
                { token = "[MEGABEAST]", weight = 50, log_name = "SCRAP MEGABEAST" },
                { token = "[FEATURE_BEAST]", weight = 50, log_name = "SCRAP FORGOTTENBEAST" }
            }
        },
        INDUSTRIAL = {
            GNT = {
                { token = "[SEMIMEGABEAST]", weight = 100, log_name = "INDUSTRIAL SEMIMEGABEAST" }
            },
            TTN = {
                { token = "[MEGABEAST]", weight = 20, log_name = "INDUSTRIAL MEGABEAST" },
                { token = "[FEATURE_BEAST]", weight = 80, log_name = "INDUSTRIAL FORGOTTENBEAST" }
            }
        }
    },
    XENOMACHINE = {
        GHOST = {
            GNT = {
                { token = "[SEMIMEGABEAST]", weight = 100, log_name = "GHOST SEMIMEGABEAST" }
            },
            TTN = {
                { token = "[MEGABEAST]", weight = 50, log_name = "GHOST MEGABEAST" },
                { token = "[FEATURE_BEAST]", weight = 50, log_name = "GHOST FORGOTTENBEAST" }
            }
        },
        CHAOS = {
            GNT = {
                { token = "[SEMIMEGABEAST]", weight = 100, log_name = "CHAOS SEMIMEGABEAST" }
            },
            TTN = {
                { token = "[MEGABEAST]", weight = 20, log_name = "CHAOS MEGABEAST" },
                { token = "[FEATURE_BEAST]", weight = 80, log_name = "CHAOS FORGOTTENBEAST" }
            }
        }
    },
    NANOMACHINE = {
        CORRUPT = {
            GNT = {
                { token = "[SEMIMEGABEAST]", weight = 100, log_name = "CORRUPT SEMIMEGABEAST" }
            },
            TTN = {
                { token = "[MEGABEAST]", weight = 50, log_name = "CORRUPT MEGABEAST" },
                { token = "[FEATURE_BEAST]", weight = 50, log_name = "CORRUPT FORGOTTENBEAST" }
            }
        },
        PRISTINE = {
            GNT = {
                { token = "[SEMIMEGABEAST]", weight = 100, log_name = "PRISTINE SEMIMEGABEAST" }
            },
            TTN = {
                { token = "[MEGABEAST]", weight = 20, log_name = "PRISTINE SEMIMEGABEAST" },
                { token = "[FEATURE_BEAST]", weight = 80, log_name = "PRISTINE FORGOTTENBEAST" }
            }
        }
    }
}
