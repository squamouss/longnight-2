return {
    ...
    },
    {
        ...
        size_tags = {"LESSER"},
        tok = {[[
		[CREATURE_TILE:'p'][CREATURE_CLASS:SIZE_LESSER][CREATURE_CLASS:PROTOCHIMERA_SIZE_LESSER]
    ...
    },
    {
        ...
        tok = {[[
		[CREATURE_TILE:'p'][CREATURE_CLASS:SIZE_MEDIUM][CREATURE_CLASS:PROTOCHIMERA_SIZE_MEDIUM]
    ...
    },
    {
        ...
        weight = 20,
        tok = {[[
		[CREATURE_TILE:'P'][CREATURE_CLASS:SIZE_LARGE][CREATURE_CLASS:PROTOCHIMERA_SIZE_LARGE]
    ...
    },
    {
        ...
        weight = 10,
        tok = {[[
		[CREATURE_TILE:'P'][CREATURE_CLASS:SIZE_HUGE][CREATURE_CLASS:PROTOCHIMERA_SIZE_HUGE][SAVAGE]
    ...
    },
    {
        ...
        weight = 5,
        tok = {[[
		[CREATURE_TILE:'N'][CREATURE_CLASS:SIZE_GIANT][CREATURE_CLASS:PROTOCHIMERA_SIZE_GIANT]
    ...
    },
    {
        ...
        weight = 1,
        tok = {[[
		[CREATURE_TILE:'N'][CREATURE_CLASS:SIZE_TITANIC][CREATURE_CLASS:PROTOCHIMERA_SIZE_TITANIC]
        ...
        procgen_subchart_table_1_1 = {
            {
                ...
                gaits = { STANDARD_SWIMMING_GAITS = 5 },
                tok = {[[
					[CREATURE_TILE:224]
                   [VERMIN_FISH]
                ]]},
            ...
            },
            {
                ...
                eligible_rating_tags = {"AMBIENT"},
				eligible_size_tags = {"MINIMAL", "SMALL"},
                gaits = { STANDARD_SWIMMING_GAITS = 10 },
                tok = {[[
					[CREATURE_TILE:224]
                   [VERMIN_FISH]
                ]]},
            ...
            },
            {
                ...
                eligible_rating_tags = {"AMBIENT"},
				eligible_size_tags = {"MINIMAL", "SMALL"},
                gaits = { STANDARD_SWIMMING_GAITS = 20 },
                tok = {[[
					[CREATURE_TILE:224]
                   [VERMIN_FISH]
                ]]},
            ...
            },
            {
				...
				eligible_rating_tags = {"DANGEROUS", "HAZARDOUS", "BENIGN", "PROBLEMATIC", "AMBIENT", "VERMIN"},
				eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"},
                gaits = { STANDARD_SWIMMING_GAITS = 30 },
                tok = {[[
                ]]},
                weight = 50
            },
            {
				...
				eligible_rating_tags = {"DANGEROUS", "HAZARDOUS", "BENIGN", "PROBLEMATIC", "AMBIENT", "VERMIN"},
				eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"},
                gaits = { STANDARD_SWIMMING_GAITS = 40 },
                tok = {[[
                ]]},
                weight = 30
            },
            {
				...
				eligible_rating_tags = {"DANGEROUS", "HAZARDOUS", "BENIGN", "PROBLEMATIC", "AMBIENT", "VERMIN"},
				eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"},
                gaits = { STANDARD_SWIMMING_GAITS = 50 },
                tok = {[[
                ]]},
                weight = 20
            }
        ...
        procgen_subchart_table_1_2 = {
            {
                ...
                gaits = { STANDARD_QUADRUPED_GAITS = 1 },
                tok = {[[
					[CREATURE_TILE:126]
            ...
            },
            {
                ...
                gaits = { STANDARD_QUADRUPED_GAITS = 5 },
                tok = {[[
					[CREATURE_TILE:126]
                   [VERMIN_GROUNDER][VERMIN_SOIL][BIOME:ANY_LAND]
                ]]},
            ...
            },
            {
                ...
                gaits = { STANDARD_QUADRUPED_GAITS = 10 },
                tok = {[[
                ]]},
                weight = 50
            },
            {
				...
				eligible_size_tags = {"LESSER", "MEDIUM"},
                gaits = { STANDARD_QUADRUPED_GAITS = 30 },
                tok = {[[
                ]]},
                weight = 50
            },
            {
				...
				eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"},
                gaits = { STANDARD_QUADRUPED_GAITS = 20 },
                tok = {[[
                ]]},
                weight = 50
            },
            {
                ...
                gaits = { STANDARD_QUADRUPED_GAITS = 40 },
                tok = {[[
                ]]},
                weight = 50
            },
            {
				...
				eligible_size_tags = {"LESSER", "MEDIUM", "LARGE"},
                gaits = { STANDARD_QUADRUPED_GAITS = 5, STANDARD_FLYING_GAITS = 30 },
                tok = {[[
					[FLIER]
                ]]},
                weight = 20
            },
            {
                ...
                eligible_rating_tags = {"HAZARDOUS", "DANGEROUS", "BENIGN", "PROBLEMATIC"},
				eligible_size_tags = {"LESSER", "MEDIUM", "LARGE"},
                gaits = { STANDARD_QUADRUPED_GAITS = 5, STANDARD_FLYING_GAITS = 40 },
                tok = {[[
					[FLIER]
                ]]},
                weight = 20
