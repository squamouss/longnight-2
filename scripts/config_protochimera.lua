return {
    ...
    interaction_rating = {
        ...
        },
        {
            ...
            [FREQUENCY:10][CLUSTER_NUMBER:1:2]
            ]]},
            tags = {"DANGEROUS"},
            weight = 5,
            enabled = true,
        ...
        },
        {
            ...
            [FREQUENCY:20][CLUSTER_NUMBER:1:5]
            ]]},
            tags = {"HAZARDOUS"},
            weight = 25,
            enabled = true,
        ...
        },
        {
            ...
            [FREQUENCY:50][CLUSTER_NUMBER:1:10][LOOSE_CLUSTERS]
            ]]},
            tags = {"BENIGN"},
            weight = 40,
            enabled = true,
        ...
        },
        {
            ...
            [FREQUENCY:30][CLUSTER_NUMBER:1:3][LOOSE_CLUSTERS]
            ]]},
            tags = {"PROBLEMATIC"},
            weight = 20,
            enabled = true,
