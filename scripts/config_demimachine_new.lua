return {
    ...
    generic_creature_lore_snippets = {
        "_______________________________________________________ __________/HISTORY = Demimechs are the product of attrition and recycling, cobbled together from base materials. Cloned tissues and scrap metal, held together by low-quality nanomechanical maintenance systems. In the Transitional Era billions of them were produced to maintain the arcology factories of the ruling powers, and to die for them in long wars of brutal attrition. In time they went rogue, forming hives of their own or simply wandering into the dark. Widely consider the least among N-life, their tenacity and adaptability have seen them carve out a niche in the hostile technosystem regardless.  _______________________________________________________ __________" ,
    },
    ...
    interaction_rating = {
        ...
        },
        {
            ...
            tok = {[[
			            [COLOR:4:0:1][NIGHT_CREATURE_EXPERIMENTER]
            [ATTACK_TRIGGER:3:3:3]
            [BUILDINGDESTROYER:2]
    ...
    },
    {
        ...
        size_tags = {"LESSER"},
        tok = {[[
		[CREATURE_TILE:'b'][CREATURE_CLASS:SIZE_LESSER][CREATURE_CLASS:DEMIMACHINE_SIZE_LESSER]
    ...
    },
    {
        ...
        tok = {[[
		[CREATURE_TILE:'b'][CREATURE_CLASS:SIZE_MEDIUM][CREATURE_CLASS:DEMIMACHINE_SIZE_MEDIUM]
    ...
    },
    {
        ...
        tok = {[[
		[CREATURE_TILE:'B'][CREATURE_CLASS:SIZE_LARGE][CREATURE_CLASS:DEMIMACHINE_SIZE_LARGE]
    ...
    },
    {
        ...
        tok = {[[
		[CREATURE_TILE:'B'][CREATURE_CLASS:SIZE_HUGE][CREATURE_CLASS:DEMIMACHINE_SIZE_HUGE]
    ...
    },
    {
        ...
        weight = 1,
        tok = {[[
		[CREATURE_TILE:'B'][CREATURE_CLASS:SIZE_GIANT][CREATURE_CLASS:DEMIMACHINE_SIZE_GIANT]
    ...
    },
    {
        ...
        weight = 1,
        tok = {[[
		[CREATURE_TILE:'B'][CREATURE_CLASS:SIZE_TITANIC][CREATURE_CLASS:DEMIMACHINE_SIZE_TITANIC]
    ...
    {
        body_token = "",
        desc_part = "_______________________________________________________ __________/TYPE = A quasi-mechanical organism consisting of a metal endoskeleton wrapped in reinforced cloned tissues, not a simple cyborg but a true blending of flesh and metal into a synthesis of both. This variant descends from the arcology-factories of the Transitional Era, a pedigree known for its use in terrible, grinding wars against one another. It has a body of rugged but sophisticated cybernetics, its muscles reinforced by dense colonies of self-repairing nanites. _______________________________________________________ __________/DESC = ",
        ...
        tok = {
		[[
		[CREATURE_CLASS:DEMIMACHINE_MECHA]
		...
		size_specific_tokens = {
             ...
             ["HUGE"] = "[CASTE_TILE:'M'] ",
             ["GIANT"] = "[CASTE_TILE:'M'] ",
             ["TITANIC"] = " [CASTE_TILE:'M'] "
        },
        weight = 50,
		next_tables = {
		"procgen_subchart_table_mecha_body"
		}
    },
    {
        body_token = "",
        desc_part = "_______________________________________________________ __________/TYPE = A quasi-mechanical organism consisting of a metal endoskeleton wrapped in reinforced cloned tissues, not a simple cyborg but a true blending of flesh and metal into a synthesis of both. This variant descends from the renegade swarms which diverged from their kindred during the height of the Transitional Era, forming autonomous hives and speciating wildly to proliferate across the technosystem. Its mechanical parts are tapering and sleek, metal plating covering jointed limbs with hints of its grotesque musculature and metallic bone scaffolding underneath.  _______________________________________________________ __________/DESC = ",
        eligible_rating_tags = {"SOPHONT", "AVATAR", "DEVIANT"},
        eligible_size_tags = {"MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"}, 
		sub_archetype = {"SWARM"},
        tok = {
		[[
		[CREATURE_CLASS:DEMIMACHINE_SWARM]
    ...
    {
        body_token = "",
        desc_part = "_______________________________________________________ __________/TYPE = A quasi-mechanical organism consisting of a metal endoskeleton wrapped in reinforced cloned tissues, not a simple cyborg but a true blending of flesh and metal into a synthesis of both. This variant descends from the desperate populations of the early Fade, who willingly converted themselves into demimachine life for a better chance at survival. Its machinery is spindly and utilitarian with traces of curving organic design, resembling a flayed corpse in its exposed, distorted metallic bones and artificial musculature wrapped atop them. _______________________________________________________ __________/DESC = ",
        ...
        eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"}, 
		sub_archetype = {"FRANKENSTEIN"},
        tok = {
		[[
		[CREATURE_CLASS:DEMIMACHINE_FRANKENSTEIN]
		...
		next_tables = {
		"procgen_subchart_table_frankenstein_body"
		}
