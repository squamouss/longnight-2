...
return {
    ...
    },
    {
		...
		},
        {
            ...
            size_tags = {"LESSER"}, 
            tok = {[[
            [CREATURE_TILE:'*'][CREATURE_CLASS:SIZE_LESSER][CREATURE_CLASS:POLYMERID_SIZE_LESSER]
        ...
        [CREATURE_TILE:'*']
        [CREATURE_CLASS:SIZE_MEDIUM][CREATURE_CLASS:POLYMERID_SIZE_MEDIUM]
        ...
        },
        {
            ...
            weight = 20, 
            tok = {[[
            [CREATURE_TILE:015][CREATURE_CLASS:SIZE_LARGE][CREATURE_CLASS:POLYMERID_SIZE_LARGE]
        ...
        },
        {
            ...
            size_tags = {"HUGE"}, 
            tok = {[[
            [CREATURE_TILE:015][CREATURE_CLASS:SIZE_HUGE][CREATURE_CLASS:POLYMERID_SIZE_HUGE][SAVAGE]
            [SAVAGE]
        ...
        },
        {
            ...
            size_tags = {"GIANT"}, 
            tok = {[[
			[CREATURE_TILE:015][CREATURE_CLASS:SIZE_GIANT][CREATURE_CLASS:POLYMERID_SIZE_GIANT]
            [SAVAGE]
            [CREATURE_CLASS:HUGEHEAD]
            [CREATURE_CLASS:HUGEARMS]
            [CREATURE_CLASS:HUGESHOULDERS]
        ...
        },
        {
            ...
            size_tags = {"TITANIC"}, 
            tok = {[[
           [CREATURE_TILE:015][CREATURE_CLASS:SIZE_TITAN][CREATURE_CLASS:POLYMERID_SIZE_TITANIC]
            ]]}, 
            weight = 1,
            enabled = false
        }
        ...
        procgen_subchart_table_bug = {
			{
				...
				gaits = { STANDARD_WALK_CRAWL_GAITS = 2, STANDARD_CLIMBING_GAITS = 2, STANDARD_SWIMMING_GAITS = 2, STANDARD_CRAWLING_GAITS = 2 },
				tok = {[[
				[CANNOT_JUMP]
				]]},
                weight = 50,
            ...
            },
			{
				...
				eligible_rating_tags = {"AMBIENT", "VERMIN"},
				eligible_size_tags = {"MICRO", "MINIMAL", "SMALL"},
				gaits = { STANDARD_FLYING_GAITS = 2, STANDARD_WALK_CRAWL_GAITS = 2, STANDARD_CLIMBING_GAITS = 2, STANDARD_SWIMMING_GAITS = 2, STANDARD_CRAWLING_GAITS = 2 },
				tok = {[[
				[CANNOT_JUMP]
				[FLIER]
				]]},
...
----------------------------------------------------------------------------------------------------------------------------------------
            ...
            },
			{
				...
				eligible_size_tags = {"MICRO", "MINIMAL", "SMALL", "LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT"},
				gaits = { STANDARD_WALK_CRAWL_GAITS = 10, STANDARD_CLIMBING_GAITS = 10, STANDARD_SWIMMING_GAITS = 5, STANDARD_CRAWLING_GAITS = 2 },
				tok = {[[
				[CANNOT_JUMP]
				]]},
                weight = 50,
            ...
            },
			{
				...
				eligible_rating_tags = {"DANGEROUS", "PROBLEMATIC", "HAZARDOUS", "BENIGN"},
				eligible_size_tags = {"MICRO", "MINIMAL", "SMALL", "LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT"},
				gaits = { STANDARD_WALK_CRAWL_GAITS = 20, STANDARD_CLIMBING_GAITS = 20, STANDARD_SWIMMING_GAITS = 5, STANDARD_CRAWLING_GAITS = 10 },
				tok = {[[
				]]},
                weight = 50,
				next_tables = {"procgen_subchart_table_abdomen"}
	...
	[APPLY_CREATURE_VARIATION:PINCER_ATTACK]
            ...
            },
			{
				...
				eligible_rating_tags = {"DANGEROUS", "PROBLEMATIC", "HAZARDOUS", "BENIGN"},
				eligible_size_tags = {"MICRO", "MINIMAL", "SMALL", "LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT"},
				gaits = { STANDARD_FLYING_GAITS = 20, STANDARD_WALK_CRAWL_GAITS = 20, STANDARD_CLIMBING_GAITS = 20, STANDARD_SWIMMING_GAITS = 5, STANDARD_CRAWLING_GAITS = 10 },
				tok = {[[
				[CANNOT_JUMP]
				]]},
                weight = 50,
            ...
            },
			{
				...
				eligible_size_tags = {"MICRO", "MINIMAL", "SMALL", "LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT"},
				gaits = { STANDARD_FLYING_GAITS = 40, STANDARD_WALK_CRAWL_GAITS = 20, STANDARD_CLIMBING_GAITS = 20, STANDARD_SWIMMING_GAITS = 5, STANDARD_CRAWLING_GAITS = 10 },
				tok = {[[
				[CANNOT_JUMP]
				]]},
                weight = 50,
			...
			{
                body_token = "6LEG:4WINGS:",
                desc_part = "six long legs and a pair of flowing wings colored like oil on water, resembling the lost pollinators of the homeworld. ",
				transcendent_desc_part = "",
				eligible_rating_tags = {"DANGEROUS", "PROBLEMATIC", "HAZARDOUS", "BENIGN"},
				eligible_size_tags = {"MICRO", "MINIMAL", "SMALL", "LESSER", "MEDIUM"},
				gaits = { STANDARD_FLYING_GAITS = 30, STANDARD_WALK_CRAWL_GAITS = 20, STANDARD_CLIMBING_GAITS = 20, STANDARD_SWIMMING_GAITS = 5, STANDARD_CRAWLING_GAITS = 10 },
				tok = {[[
				[CANNOT_JUMP]
				]]},
                weight = 50,
        ...
        procgen_subchart_table_spider = {
            ...
            },
			{
				...
				eligible_rating_tags = {"AMBIENT", "VERMIN"},
				eligible_size_tags = { "MINIMAL", "SMALL"},
				gaits = { STANDARD_WALK_CRAWL_GAITS = 5, STANDARD_CLIMBING_GAITS = 5, STANDARD_SWIMMING_GAITS = 5, STANDARD_CRAWLING_GAITS = 5 },
				tok = {[[
				[CANNOT_JUMP]
				]]},
                weight = 50,
...
----------------------------------------------------------------------------------------------------------------------------------------
            ...
            },
			{
				...
				eligible_size_tags = { "MINIMAL", "SMALL", "LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT"},
				gaits = { 
				STANDARD_WALK_CRAWL_GAITS = 10, 
				STANDARD_CLIMBING_GAITS = 10, 
				STANDARD_SWIMMING_GAITS = 5, 
				STANDARD_CRAWLING_GAITS = 2 
				},
				tok = {[[
				[CANNOT_JUMP]
	[APPLY_CREATURE_VARIATION:PINCER_ATTACK]
        ...
        procgen_subchart_table_crab = {
			{
				...
				eligible_size_tags = { "MINIMAL", "SMALL"}, 
				gaits = { 
				STANDARD_WALK_CRAWL_GAITS = 2, 
				STANDARD_CLIMBING_GAITS = 2, 
				STANDARD_SWIMMING_GAITS = 1, 
				STANDARD_CRAWLING_GAITS = 2 
				},
				tok = {[[ 
				[CANNOT_JUMP]
            ...
            },
			{
				...
				eligible_size_tags = { "MINIMAL", "SMALL"}, 
				gaits = { 
				STANDARD_WALK_CRAWL_GAITS = 5, 
				STANDARD_CLIMBING_GAITS = 5, 
				STANDARD_SWIMMING_GAITS = 1, 
				STANDARD_CRAWLING_GAITS = 5 
				},
				tok = {[[ 
				[CANNOT_JUMP]
				]]}, 
...
----------------------------------------------------------------------------------------------------------------------------------------
            ...
            },
			{
				...
				eligible_size_tags = { "MINIMAL", "SMALL", "LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT"}, 
				gaits = { 
				STANDARD_WALK_CRAWL_GAITS = 15, 
				STANDARD_CLIMBING_GAITS = 15, 
				STANDARD_SWIMMING_GAITS = 5, 
				STANDARD_CRAWLING_GAITS = 2 
				},
				tok = {[[ 
            ...
            },
			{
				...
				eligible_size_tags = { "MINIMAL", "SMALL", "LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT"}, 
				gaits = { 
				STANDARD_WALK_CRAWL_GAITS = 20, 
				STANDARD_CLIMBING_GAITS = 20, 
				STANDARD_SWIMMING_GAITS = 5, 
...
----------------------------------------------------------------------------------------------------------------------------------------
            ...
            },
			{
				...
				eligible_size_tags = { "MINIMAL", "SMALL", "LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT"}, 
				gaits = { 
				STANDARD_WALK_CRAWL_GAITS = 30, 
				STANDARD_CLIMBING_GAITS = 30, 
				STANDARD_SWIMMING_GAITS = 5, 
				STANDARD_CRAWLING_GAITS = 30 
				},
				tok = {[[ 
				[CANNOT_JUMP]
				]]}, 
