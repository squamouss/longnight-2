...
return {
    ...
    generic_creature_lore_snippets = {
        "Polymerids are the descendants of engineered scavengers, recyclers, and bioweapons of the Transitional Era, displacing conventional invertebrates and filling many of the niches they once occupied, along with ones once filled by larger creatures. ",
    },
