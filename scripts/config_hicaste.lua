...
return {
    ...
    generic_body_size_variants = {
        ...
        },
        {
            ...
            size_tags = {"LESSER"}, 
            tok = {[[
            [CREATURE_CLASS:SIZE_LESSER][CREATURE_CLASS:HICASTE_SIZE_LESSER]
        ...
        STANDARD_SWIMMING_GAITS = 10
            ...
            tok = {[[
            [CREATURE_CLASS:SIZE_MEDIUM][CREATURE_CLASS:HICASTE_SIZE_MEDIUM]
        ...
        STANDARD_SWIMMING_GAITS = 10
            ...
            tok = {[[
            [CREATURE_TILE:'N'][CREATURE_CLASS:SIZE_LARGE][CREATURE_CLASS:HICASTE_SIZE_LARGE]
        ...
        },
        {
            ...
            size_tags = {"HUGE"}, 
            tok = {[[
            [CREATURE_TILE:'N'][CREATURE_CLASS:SIZE_HUGE][CREATURE_CLASS:HICASTE_SIZE_HUGE][SAVAGE]
        ...
        },
        {
            ...
            size_tags = {"GIANT"}, 
            tok = {[[
            [CREATURE_TILE:'N'][CREATURE_CLASS:SIZE_GIANT][CREATURE_CLASS:HICASTE_SIZE_GIANT]
        ...
        },
        {
            ...
            size_tags = {"TITANIC"}, 
            tok = {[[
            [CREATURE_TILE:'N'][CREATURE_CLASS:SIZE_TITAN][CREATURE_CLASS:HICASTE_SIZE_TITANIC]
            ]]}, 
            weight = 1,
            enabled = true
        }
