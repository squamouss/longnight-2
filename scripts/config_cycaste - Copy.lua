...
return {
    ...
    {
        body_token = "MACHINE_LIMBLESS_UPPER:MACHINE_HEAD_NECK:2LUNGS:HEART:ORGANS:SPINE:BRAIN:SKULL",
        desc_part = "_______________________________________________________ __________/TYPE = A mass of human organs contained within a mechanical shell of hereditary augmentations, nearly fully divorced from conventional biology. This variant is a sophisticated design born from the Transitional Era, all segments and ball joints connected to a protruding central cocoon housing its organs, a style which up the populations which ruled that era before being displaced by true posthumanity.  _______________________________________________________ __________/DESC = ",
        eligible_rating_tags = {"SOPHONT", "HOSTILE"},
        eligible_size_tags = {"MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"}, 
		sub_archetype = {"SLEEK"},
        tok = {
    ...
    {
        body_token = "MACHINE_LIMBLESS_UPPER:MACHINE_HEAD_NECK:2LUNGS:HEART:ORGANS:SPINE:BRAIN:SKULL",
        desc_part = "_______________________________________________________ __________/TYPE = A mass of human organs contained within a mechanical shell of hereditary augmentations, nearly fully divorced from conventional biology. This variant is an exotic design of the Atrophic Era's desperate efforts at survival; a skeletal frame of exposed pneumatics, wires, and bulbous containers packed into a ribcage-like container, cradling the biological organs that command it.  _______________________________________________________ __________/DESC = ",
    ...
    flowchart_data = {
		...
		"procgen_subchart_table_bulk_other"
            ...
            {     
                body_token = "", 
                desc_part = "It has a compact, radially-oriented body, with ",
				eligible_rating_tags = {"SOPHONT", "DEVIANT", "HOSTILE"},
                eligible_size_tags = {"LARGE", "HUGE", "GIANT", "TITANIC"}, 
                tok = {[[
		...
		"procgen_subchart_table_bulk_other"
            ...
            {     
                body_token = "", 
                desc_part = "It has a tall, vertically-oriented body, with ",
				eligible_rating_tags = {"SOPHONT", "DEVIANT", "HOSTILE"},
                eligible_size_tags = {"LARGE", "HUGE", "GIANT", "TITANIC"}, 
                tok = {[[
        ...
        procgen_subchart_table_bulk_head = {
            {    
                body_token = ":MACHINEMOUTH:MACHINETEETH", 
	...
	[TL_COLOR_MODIFIER:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1]
		...
		"procgen_subchart_table_bulk_neck",
            ...
            {     
                body_token = "MACHINEMOUTH:MACHINETEETH:", 
                desc_part = "It has a lifelike articulated faceplate with ",
	...
	[TL_COLOR_MODIFIER:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1:WHITE:1]
        ...
        procgen_subchart_table_bulk_eyes = {
            {    
                body_token = "two mechanical eyes with glowing irises, ", 
                desc_part = "2MACHINEEYES",
				eligible_rating_tags = {"SOPHONT"},
                eligible_size_tags = {"MEDIUM", "LARGE", "HUGE"}, 
                tok = {[[
		...
		[BP_APPEARANCE_MODIFIER:LARGE_IRIS:25:70:90:100:110:130:200]
            ...
            {     
                body_token = "four mechanical eyes with glowing irises aligned horizontally with the second pair to the sides of the first, ", 
                desc_part = "4MACHINEEYES",
				eligible_rating_tags = {"SOPHONT"},
                eligible_size_tags = {"MEDIUM", "LARGE", "HUGE", "GIANT"}, 
                tok = {[[
	...
	[VISION_ARC:50:310]
		...
		[BP_APPEARANCE_MODIFIER:LARGE_IRIS:25:70:90:100:110:130:200]
            ...
            {     
                body_token = "four mechanical eyes with glowing irises aligned with two above and to the sides of the primary pair, ", 
                desc_part = "4MACHINEEYES",
				eligible_rating_tags = {"SOPHONT"},
                eligible_size_tags = {"MEDIUM", "LARGE", "HUGE", "GIANT"}, 
                tok = {[[
	...
	[VISION_ARC:50:310]
		...
		[BP_APPEARANCE_MODIFIER:LARGE_IRIS:25:70:90:100:110:130:200]
            ...
            {     
                body_token = "four mechanical eyes with glowing irises aligned with two above the primary pair, ", 
                desc_part = "4MACHINEEYES",
				eligible_rating_tags = {"SOPHONT"},
                eligible_size_tags = {"MEDIUM", "LARGE", "HUGE", "GIANT"}, 
                tok = {[[
		...
		[BP_APPEARANCE_MODIFIER:LARGE_IRIS:25:70:90:100:110:130:200]
            ...
            {     
                body_token = "six mechanical eyes with glowing irises aligned horizontally with the secondary pairs to the sides of the first, ", 
                desc_part = "6MACHINEEYES",
				eligible_rating_tags = {"SOPHONT"},
	...
	[VISION_ARC:50:310]
		...
		[BP_APPEARANCE_MODIFIER:LARGE_IRIS:25:70:90:100:110:130:200]
            ...
            {     
                body_token = "six mechanical eyes with glowing irises aligned with two pairs above and to the sides of the primary pair, ", 
                desc_part = "6MACHINEEYES",
				eligible_rating_tags = {"SOPHONT"},
                eligible_size_tags = {"LARGE", "HUGE", "GIANT"}, 
                tok = {[[
	...
	[VISION_ARC:50:310]
		...
		[BP_APPEARANCE_MODIFIER:LARGE_IRIS:25:70:90:100:110:130:200]
            ...
            {     
                body_token = "six mechanical eyes with glowing irises aligned with four in two rows above the primary pair, ", 
                desc_part = "6MACHINEEYES",
				eligible_rating_tags = {"SOPHONT"},
                eligible_size_tags = {"LARGE", "HUGE", "GIANT"}, 
                tok = {[[
		...
		[BP_APPEARANCE_MODIFIER:LARGE_IRIS:25:70:90:100:110:130:200]
            ...
            {     
                body_token = "six mechanical eyes with glowing irises aligned in two groups of three where normal eyes ought to be, ", 
                desc_part = "6MACHINEEYES",
				eligible_rating_tags = {"SOPHONT"},
                eligible_size_tags = {"LARGE", "HUGE", "GIANT"}, 
                tok = {[[
