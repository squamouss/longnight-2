...
local modules_to_bust = {
    ...
    "weaponizer_engine",  -- Added
    "config_weapons"      -- Added
}
...
local weaponizer_engine = safe_require("weaponizer_engine") -- [[ NEW ]]
local config_weapons = safe_require("config_weapons")       -- [[ NEW ]]
...
safe_require("languages.conlang_postcant")
...
local experiment_transformation_module = safe_require("experiment_transformation")
            ...
            for _, creature_obj in ipairs(generated_data) do
                if creature_obj.creature then
                    ...
                    if weaponizer_engine and config_weapons then
                        ...
                        -- Replace original with weaponized version for registration
...
table.insert(do_once, function()
    ...
    -- 1. Main Civilization Generation
    ...
    -- 2. Invasion Civilization Generation
    ...
    -- 3. Domestic Creature Generation 
    ...
    -- 4. Tribe Civilization Generation 
    ...
    -- 1. Specific N-Core Transformations
    ...
    -- 3. Experiment Transformations
    if experiment_transformation_module and experiment_transformation_module.preprocess and experiment_transformation_module.preprocess.experiment_init then
        pcall(experiment_transformation_module.preprocess.experiment_init, combined_generated_creature_data)
        _G.log("INIT_LOG: Experiment transformation hook finished.")
    else
        _G.log("INIT_LOG: WARNING - experiment_transformation_module or its preprocess hook is missing.")
    end
    -- =====================================================================================
    ...
    _G.log("INIT_LOG: Executing attribute buff system generation...")
