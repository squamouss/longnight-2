...
return {
    ...
    generic_body_size_variants = {
		...
		},
        {
            ...
            size_tags = {"LESSER"}, 
            tok = {[[
            [CREATURE_TILE:'c'][CREATURE_CLASS:SIZE_LESSER][CREATURE_CLASS:CHIMERA_SIZE_LESSER]
        ...
        [CREATURE_TILE:'c']
        [CREATURE_CLASS:SIZE_MEDIUM][CREATURE_CLASS:CHIMERA_SIZE_MEDIUM]
        ...
        },
        {
            ...
            weight = 20, 
            tok = {[[
            [CREATURE_TILE:'C'][CREATURE_CLASS:SIZE_LARGE][CREATURE_CLASS:CHIMERA_SIZE_LARGE]
        ...
        },
        {
            ...
            size_tags = {"HUGE"}, 
            tok = {[[
            [CREATURE_TILE:'C'][CREATURE_CLASS:SIZE_HUGE][CREATURE_CLASS:CHIMERA_SIZE_HUGE][SAVAGE]
            [SAVAGE]
        ...
        },
        {
            ...
            size_tags = {"GIANT"}, 
            tok = {[[
            [CREATURE_TILE:'C'][CREATURE_CLASS:SIZE_GIANT][CREATURE_CLASS:CHIMERA_SIZE_GIANT]
            [SAVAGE]
            [CREATURE_CLASS:HUGEHEAD]
            [CREATURE_CLASS:HUGEARMS]
            [CREATURE_CLASS:HUGESHOULDERS]
        ...
        },
        {
            ...
            size_tags = {"TITANIC"}, 
            tok = {[[
            [CREATURE_TILE:'E'][CREATURE_CLASS:SIZE_TITAN][CREATURE_CLASS:CHIMERA_SIZE_TITANIC]
            ]]}, 
            weight = 1,
            enabled = false
        }
...
[ATTACK:SCRATCH:CHILD_TISSUE_LAYER_GROUP:BY_TYPE:GRASP:BY_CATEGORY:ALL:NAIL]
    ...
    [ATTACK_PRIORITY:SECOND]
        ...
        {
            body_token = "BASIC_FRONTLEGS:BASIC_REARLEGS:BASIC_3PARTARMS:5TOES:5FINGERS:2WINGS:",
            desc_part = "four muscular, straight digitigrade legs supporting its weight along with a pair of membranous wings, a pair of eerily humanoid arms and hands hanging from the front of its body. ",
            transcendent_desc_part = "",
            eligible_rating_tags = {"DANGEROUS", "HAZARDOUS"},
            eligible_size_tags = {"LESSER", "MEDIUM"}, 
            gaits = {
