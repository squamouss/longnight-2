...
return {
    ...
    generic_creature_lore_snippets = {
        " During the Transitional Era, cycastes were often the ruling class of the arcology-megacities that dominated the period, the old restrictions on cybernetics left by the wayside as humanity augmented itself into new forms of life. Though their prominence has faded in the face of Transcendence, they remain a common sight in human civilization, with larger specimens on par with any vehicular war machine. But these days they are considered an outdated, barbaric form of existence, with many having degraded into maddened itinerants or wandering disasters, endlessly seeking fresh parts to replace their old ones. ",
    },
