-- scripts/civ_data/data_manager.lua
...
for _, module_path in ipairs(data_modules) do
    ...
    if success then
        ...
        if data_module.armor_data then
            deep_merge(master_flowchart_data, data_module.armor_data)
            log("DATA_MANAGER: Merged armor data (as flowchart) from '" .. module_path .. "'.")
        end
