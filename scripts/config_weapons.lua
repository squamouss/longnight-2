return {
    ...
    WEAPONS = {
        ...
        CHEMGUN_TURRET = {
			...
			eligible_sub_archetypes = {"DEVIL", "HORROR", "OGRE", "HUMAN", "ANDROID", "INDUSTRIAL", "DOLL", "SCRAP", "MECHA", "SWARM", "FRANKENSTEIN", "HYBRID", "CONTROL", "BLINDSIGHT", "CYBORG", "FULLBODY" },
            eligible_size_tags = {"MEDIUM"},
...
--=================================================================================================================			
	...
	[ATTACK:KICK:BODYPART:BY_TOKEN:RSCYTHE]		
		...
		[ATTACK_PRIORITY:MAIN]
			...
			eligible_sub_archetypes = {"HORROR", "DOLL", "SCRAP", "SWARM", "FRANKENSTEIN", "CORRUPT", "HYBRID", "CHAOS", "BLINDSIGHT", "CYBORG", "SLEEK", "SKELETON" },
            eligible_size_tags = {"MEDIUM", "LARGE", "HUGE", "GIANT", "TITAN"},
            eligible_rating_tags = {"HOSTILE", "DANGEROUS", "EXISTENTIAL"},
            exclusion_group =  "RIGHTWEAPON", 
            pop_ratio_multiplier = 0.5
