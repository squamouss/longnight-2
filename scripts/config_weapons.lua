return {
    ...
    WEAPONS = {
        ...
        CHEMGUN_TURRET = {
            ...
            eligible_archetypes = {"BIOMACHINE", "CYBERMACHINE", "NANOMACHINE", "DEMIMACHINE", "EXCASTE", "NUCASTE", "CYCASTE" },
...
--=================================================================================================================						
	...
	[ATTACK:KICK:BODYPART:BY_TOKEN:RBLADE]		
		...
		[ATTACK_PRIORITY:MAIN]
			...
			eligible_sub_archetypes = {"DEVIL", "OGRE", "ANDROID", "INDUSTRIAL", "DOLL", "SCRAP", "MECHA", "SWARM", "FRANKENSTEIN", "PRISTINE", "HYBRID", "CONTROL", "BLINDSIGHT", "CYBORG", "ART", "SKELETON" },
...
--=================================================================================================================			
	...
	[ATTACK:KICK:BODYPART:BY_TOKEN:RSCYTHE]		
		...
		[ATTACK_PRIORITY:MAIN]
			...
			eligible_sub_archetypes = {"HORROR", "DOLL", "SCRAP", "SWARM", "FRANKENSTEIN", "CORRUPT", "HYBRID", "CHAOS", "BLINDSIGHT", "CYBORG", "ART", "SKELETON" },
            eligible_size_tags = {"MEDIUM", "LARGE", "HUGE", "GIANT", "TITAN"},
            eligible_rating_tags = {"HOSTILE", "DANGEROUS", "EXISTENTIAL"},
            exclusion_group =  "RIGHTWEAPON", 
            pop_ratio_multiplier = 0.5
...
--=================================================================================================================		
	...
	[ATTACK:KICK:BODYPART:BY_TOKEN:RPILEBUNKER]		
		...
		[ATTACK_PRIORITY:MAIN]
			...
			eligible_sub_archetypes = {"ANDROID", "INDUSTRIAL", "DOLL", "SCRAP", "MECHA", "FRANKENSTEIN", "HYBRID", "CONTROL", "BLINDSIGHT", "CYBORG", "BULK", "ART", "SKELETON" },
            eligible_size_tags = {"MEDIUM", "LARGE", "HUGE", "GIANT", "TITAN"},
            eligible_rating_tags = {"HOSTILE", "DANGEROUS", "EXISTENTIAL"},
            exclusion_group =  "RIGHTWEAPON", 
            pop_ratio_multiplier = 0.5
