...
local CUSTOM_SECRET_NAMES = { 
    ["BIOMACHINE_DEVIL"] = "designs of the oldest biomechanical lineage",
    ["BIOMACHINE_HUMAN"] = "designs of modern biomachinery",
    ["BIOMACHINE_OGRE"] = "designs of Transitional Era biomechs",
    ["BIOMACHINE_HORROR"] = "designs of Myriad-derived biomechs",
