...
return {
    ...
    generic_creature_lore_snippets = {
        "_______________________________________________________ __________/HISTORY = The Nucaste are the descendants of those who broke away from the caste system of the Geno-Archons following their collapse, turning to radical bioengineering and hereditary cybernetics to carve new niches for their people and empower themselves. This was rarely without cost, the delayed self-destruct mechanisms woven into their genome triggering at the slightest attempt at tampering, but those who survived such efforts would go on to become the new masters of the Transitional Era. _______________________________________________________ __________",
    },
   ...
   interaction_rating = {
    ...
    generic_body_size_variants = {
        ...
        },
        {
            ...
            size_tags = {"LESSER"}, 
            tok = {[[
            [CREATURE_TILE:'u'][CREATURE_CLASS:SIZE_LESSER][CREATURE_CLASS:NUCASTE_SIZE_LESSER]
        ...
        [CREATURE_TILE:'u']
        [CREATURE_SOLDIER_TILE:129]CREATURE_CLASS:SIZE_MEDIUM][CREATURE_CLASS:NUCASTE_SIZE_MEDIUM]
        ...
        STANDARD_SWIMMING_GAITS = 10
            ...
            tok = {[[
            [CREATURE_TILE:'U'][CREATURE_CLASS:SIZE_LARGE][CREATURE_CLASS:NUCASTE_SIZE_LARGE]
        ...
        },
        {
            ...
            size_tags = {"HUGE"}, 
            tok = {[[
            [CREATURE_TILE:'U'][CREATURE_CLASS:SIZE_HUGE][CREATURE_CLASS:NUCASTE_SIZE_HUGE]
        ...
        },
        {
            ...
            size_tags = {"GIANT"}, 
            tok = {[[
            [CREATURE_TILE:'U'][CREATURE_CLASS:SIZE_GIANT][CREATURE_CLASS:NUCASTE_SIZE_GIANT]
        ...
        },
        {
            ...
            size_tags = {"TITANIC"}, 
            tok = {[[
            [CREATURE_TILE:'U'][CREATURE_CLASS:SIZE_TITAN][CREATURE_CLASS:NUCASTE_SIZE_TITANIC]
            ]]}, 
            weight = 1,
            enabled = false
        }
    ...
    procgen_table_sub_archetype = {
    {
        ...
        desc_part = "_______________________________________________________ __________/TYPE = A human of the Transitional Era, the product of hereditary cyberization through N-matter in defiance of the genetic caste system. It is a mix of minimalistic mechanical augmentations and sickly flesh, often suffering from genetic diseases and a weakened immune system. This variant was the common citizen of the factory-arcologies during the Transitional Era, crowding out the high and low castes of prior millennia only to be brought down in turn when the Myriad god-entities destroyed their civilizations. _______________________________________________________ __________/DESC = ",
    ...
    {
        body_token = "TORSO_MODULAR:2LUNGS:HEART:GUTS:ORGANS:SPINE:AI_CORE:RIBCAGE",
        desc_part = "_______________________________________________________ __________/TYPE = A human of the Transitional Era, the product of hereditary cyberization through N-matter in defiance of the genetic caste system. It is a mix of minimalistic mechanical augmentations and raw, eroded flesh and exposed bone, webbed and ribbed in glistening black nanomachinery that sustain its ailing biology. This variant descends from those who were exposed to extreme concentrations of hazardous nanomachine colonies, obtaining a symbiotic half-life that spurs evolution but shortens lifespan. _______________________________________________________ __________/DESC = ",
		eligible_rating_tags = {"SOPHONT", "HOSTILE"},
        eligible_size_tags = {"MEDIUM", "LARGE"}, 
		sub_archetype = {"NANITE"},
        tok = {
		[[
		[CREATURE_CLASS:NUCASTE_CYBORG]
	...
	[BP_APPEARANCE_MODIFIER:DENSE:0:70:90:100:110:130:200]
		[APP_MOD_IMPORTANCE:10000]
			[APP_MOD_NOUN:nanomachine colonies:PLURAL]
    ...
    {
        body_token = "TORSO_MODULAR:2LUNGS:HEART:GUTS:ORGANS:SPINE:AI_CORE:RIBCAGE",
        desc_part = "_______________________________________________________ __________/TYPE = A human of the Transitional Era, the product of hereditary cyberization through N-matter in defiance of the genetic caste system. Its body is artifically perfect, more like a sculpture than any living human, but with insides riddled with disease. This variant was among the upper class of the early to middle Transitional Era, its delicate physique a sign of status when most were riddled with disease or remade into monsters, and now like the hicaste they sought to supplant they are bereft of the support systems that sustained them. _______________________________________________________ __________/DESC = ",
		eligible_rating_tags = {"SOPHONT", "HOSTILE"},
        eligible_size_tags = {"MEDIUM", "LARGE"}, 
		sub_archetype = {"EVOLVED"},
        tok = {
		[[
		[CREATURE_CLASS:NUCASTE_CYBORG]
        ...
        weight = 10,
		next_tables = {
		"procgen_subchart_table_evolved_body"
		}
    }
    },
	...
	-- 
		...
		"procgen_subchart_table_cyborg_legs"
            ...
            {     
                body_token = "", 
                desc_part = "It has a sickly, discolored body, with a life-support system of pulsing tubes and bulbous mechanical protrusions half-embedded into its body that protect its organs, raw and scarred where they burrow into flesh and bone, and ",
				eligible_rating_tags = {"SOPHONT", "HOSTILE"},
				eligible_size_tags = {"MEDIUM", "LARGE"}, 
				attribute_weight = { 
				RECUPERATION = "++", 
	...
	-- 
		...
		next_tables = { 
		"procgen_subchart_table_dermal",
		"procgen_subchart_table_evolved_head",
		"procgen_subchart_table_cyborg_arms",
		"procgen_subchart_table_cyborg_legs"
		}
            }
        ...
        procgen_subchart_table_evolved_head = {
            {    
                ...
                desc_part = "Its head is humanoid, its eyes slightly larger and nose smaller than the norm. ",
				eligible_rating_tags = {"SOPHONT", "HOSTILE"},
        ...
        procgen_subchart_table_cyborg_head = {
            {    
                body_token = ":HEADNECK_MODULAR:2EARS:THROAT:NECK:SKULL", 
                desc_part = "Its head is humanoid, with metal studs haphazardly embedded within its cranium. ",
				eligible_rating_tags = {"SOPHONT", "HOSTILE"},
                eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"}, 
                tok = {[[
        [SET_BP_GROUP:BY_CATEGORY:EAR]
		...
		"procgen_subchart_table_cyborg_mouth"
            ...
            {     
                body_token = ":HEADNECK_MODULAR:2EARS:THROAT:NECK:SKULL", 
                desc_part = "Its head is humanoid, with wires growing from its spine to wrap around the musculature of its face, below the skin. ",
	...
	[ATTACK:BITE:CHILD_BODYPART_GROUP:BY_CATEGORY:HEAD:BY_CATEGORY:TOOTH]
        ...
        [ATTACK:KICK:BODYPART:BY_TYPE:STANCE]
            ...
            [ATTACK_FLAG_BAD_MULTIATTACK]
                ...
                weight = 50,
		next_tables = {
		"procgen_subchart_table_cyborg_feet"
		}
            },
            {     
	...
	[ATTACK:KICK:BODYPART:BY_TYPE:STANCE]
		...
		"procgen_subchart_table_cyborg_feet"
            ...
            { 
                ...
                desc_part = "Its lower body is a flattened, spine-like tail with a pair of small limbs emerging from the sides of each segment. ",
				eligible_rating_tags = {"SOPHONT", "HOSTILE", "VESSEL", "SERVANT", "NOMAD"},
                eligible_size_tags = {"LARGE", "HUGE", "GIANT", "TITANIC"}, 
			gaits = {  
        STANDARD_CRAWLING_GAITS = 20, 
        STANDARD_CLIMBING_GAITS = 25, 
        STANDARD_SWIMMING_GAITS = 20
			},
                tok = {[[
				
			
	[ATTACK:KICK:BODYPART:BY_CATEGORY:TAIL_ROBOT]
		[ATTACK_SKILL:STANCE_STRIKE]
		[ATTACK_VERB:kick:kicks]
		[ATTACK_CONTACT_PERC:100]
		[ATTACK_PREPARE_AND_RECOVER:4:4]
