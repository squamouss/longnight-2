...
return {
   ...
   interaction_rating = {
    ...
    generic_body_size_variants = {
        ...
        [CREATURE_TILE:'u']
        [CREATURE_SOLDIER_TILE:129]CREATURE_CLASS:SIZE_MEDIUM]
    ...
    {
        body_token = "TORSO_MODULAR:2LUNGS:HEART:GUTS:ORGANS:SPINE:AI_CORE:RIBCAGE",
        desc_part = "_______________________________________________________ __________/TYPE = A human of the Transitional Era, the product of hereditary cyberization through N-matter in defiance of the genetic caste system. It is a mix of minimalistic augmentations and sickly flesh, its features neotenic and androgynous but taken to an alien extreme. This variant was among the upper class of the early to middle Transitional Era, its delicate physique a sign of status when most were riddled with disease or remade into monsters, and now like the hicaste they sought to supplant they are bereft of the support systems that sustained them. _______________________________________________________ __________/DESC = ",
		eligible_rating_tags = {"SOPHONT", "HOSTILE"},
        eligible_size_tags = {"MEDIUM", "LARGE"}, 
