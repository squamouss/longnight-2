...
return {
    ...
    },
    {
		...
		},
        {
            ...
            size_tags = {"LESSER"}, 
            tok = {[[
            [CREATURE_TILE:111][CREATURE_CLASS:SIZE_LESSER][CREATURE_CLASS:MACROCELL_SIZE_LESSER]
        ...
        [CREATURE_TILE:'o']
        [CREATURE_CLASS:SIZE_MEDIUM][CREATURE_CLASS:MACROCELL_SIZE_MEDIUM]
        ...
        },
        {
            ...
            weight = 20, 
            tok = {[[
            [CREATURE_TILE:'O'][CREATURE_CLASS:SIZE_LARGE][CREATURE_CLASS:MACROCELL_SIZE_LARGE]
        ...
        },
        {
            ...
            size_tags = {"HUGE"}, 
            tok = {[[
            [CREATURE_TILE:'O'][CREATURE_CLASS:SIZE_HUGE][CREATURE_CLASS:MACROCELL_SIZE_HUGE][SAVAGE]
            [SAVAGE]
        ...
        },
        {
            ...
            size_tags = {"GIANT"}, 
            tok = {[[
            [CREATURE_TILE:'O'][CREATURE_CLASS:SIZE_GIANT][CREATURE_CLASS:MACROCELL_SIZE_GIANT]
            [SAVAGE]
            [CREATURE_CLASS:HUGEHEAD]
            [CREATURE_CLASS:HUGEARMS]
            [CREATURE_CLASS:HUGESHOULDERS]
        ...
        },
        {
            ...
            size_tags = {"TITANIC"}, 
            tok = {[[
            [CREATURE_TILE:'O'][CREATURE_CLASS:SIZE_TITAN][CREATURE_CLASS:MACROCELL_SIZE_TITANIC]
            ]]}, 
            weight = 1,
            enabled = true
        }
