...
local VALID_RATINGS_SET = {
    ...
    VSSL = true, AVTR = true, NCUR = true, INCR = true
}
...
DIGGER:ITEM_WEAPON_PICK]
	...
	[ARMOR:ITEM_ARMOR_UNDERGUARD_ULTRALIGHT:FORCED]
	[ARMOR:ITEM_ARMOR_UNDERGUARD_LIGHT:FORCED]
	[ARMOR:ITEM_ARMOR_UNDERGUARD_MEDIUM:FORCED]
	[ARMOR:ITEM_ARMOR_UNDERGUARD_HEAVY:FORCED]
	[ARMOR:ITEM_ARMOR_UNDERGUARD_SUPERHEAVY:FORCED]
...
M.register_all_generated_civilizations = function()
    if raws and raws.register_entities and #all_generated_invasion_civ_raws > 0 then
        ...
        log("INVASION_GEN_LOG: Batch registered " .. #all_generated_invasion_civ_raws .. " invasion civilizations (" .. idx .. " lines)")
    end
end
