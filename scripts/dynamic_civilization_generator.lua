...
-- Pre-computed set for O(1) weapon theme lookups
local WEAPON_THEME_SET = {
    CHEMGUN = true, RAILGUN = true, RAMJET = true, COIL = true
}
...
M.register_all_generated_civilizations = function()
    if raws and raws.register_entities and #all_generated_civ_raws > 0 then
        ...
        log("CIV_GEN_LOG: Batch registered " .. #all_generated_civ_raws .. " civilizations (" .. idx .. " lines)")
    end
end
