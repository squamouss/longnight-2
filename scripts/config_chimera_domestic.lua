...
return {
    ...
    generic_creature_lore_snippets = {
        "Chimeras are the feral remnants of pre-Fade gene-engineered domestics, artisanal ecosystems, and area denial bioweapons, their modular DNA built off of Solar Imperial principles and later expanded upon from the most successful products, leading to a numberless population of adaptable organisms possessing high biocompatibility with even distantly related artificial life forms, allowing them to proliferate across the Megastructures and beyond. ",
    },
