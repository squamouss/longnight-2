return {
    ...
    {
        body_token = "TORSO_MODULAR:CORE:SPINE:RIBCAGE",
        desc_part = "An artificially engineered life form made form synthetic tissues strengthened by internal nanites and alloy particulates, granting it functionality on par with any true machine. This variant is a modern transhuman configuration, built in the image of pan-human physique even if its genetic code is something else entirely. Seams on its skin split open to interface with invasive machinery. ",
    ...
    {
        body_token = "TORSO_MODULAR:CORE:SPINE:RIBCAGE",
        desc_part = "An artificially engineered life form made form synthetic tissues strengthened by internal nanites and alloy particulates, granting it functionality on par with any true machine. This variant descends from the biomechs created during the Transitional Era, hulking drudges and slave soldiers cast out into the dark to labor and slaughter without oversight or maintenance, many growing feral in their long isolation. It has thick, craggy skin with tubing half-embedded in its flesh. ",
    ...
    {
        body_token = "TORSO_MODULAR:CORE:SPINE:RIBCAGE",
        desc_part = "An artificially engineered life form made form synthetic tissues strengthened by internal nanites and alloy particulates, granting it functionality on par with any true machine. This variant descends from those degenerated beyond saving, or created so by the mad hyperintelligences of the deep Datasphere. It is abnormally, horrendously deformed, riddled with cancers, misshapen and twisted. ",
	...
	[ATTACK:KICK:BODYPART:BY_TYPE:STANCE]
		...
		"procgen_subchart_table_ogre_tail"
            ...
            {     
                body_token = ":BASIC_3PARTLEGS", 
                desc_part = "It has a pair of legs with powerful thighs that taper to sinewy points ",
    ...
    non_sophont_caste_groups = {
        {
            castes = {
                {
                    tokens = [[
					[CASTE:FEMALE][FEMALE][CREATURE_CLASS:BIOMACHINE_FEMALE]
					]],
                    description_addon = ""
                },
                {
                    tokens = [[
					[CASTE:MALE][MALE][CREATURE_CLASS:BIOMACHINE_MALE]
					]],
                    description_addon = ""
                }
            },
