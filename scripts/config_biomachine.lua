return {
    ...
    generic_body_size_variants = {
    {
        ...
        size_tags = {"MICRO"},
			gaits = { 
        STANDARD_BIPED_GAITS = 1, 
        STANDARD_CRAWLING_GAITS = 1, 
        STANDARD_CLIMBING_GAITS = 1, 
    ...
    },
    {
        ...
        tok = {[[
		[CREATURE_TILE:'b'][CREATURE_CLASS:SIZE_LESSER][CREATURE_CLASS:BIOMACHINE_SIZE_LESSER]
    ...
    },
    {
        ...
        tok = {[[
		[CREATURE_TILE:'b'][CREATURE_CLASS:SIZE_MEDIUM][CREATURE_CLASS:BIOMACHINE_SIZE_MEDIUM]
    ...
    },
    {
        ...
        tok = {[[
		[CREATURE_TILE:'B'][CREATURE_CLASS:SIZE_LARGE][CREATURE_CLASS:BIOMACHINE_SIZE_LARGE]
    ...
    },
    {
        ...
        tok = {[[
		[CREATURE_TILE:'B'][CREATURE_CLASS:SIZE_HUGE][CREATURE_CLASS:BIOMACHINE_SIZE_HUGE]
    ...
    },
    {
        ...
        weight = 1,
        tok = {[[
		[CREATURE_TILE:'B'][CREATURE_CLASS:SIZE_GIANT][CREATURE_CLASS:BIOMACHINE_SIZE_GIANT]
    ...
    },
    {
        ...
        tok = {[[
		[CREATURE_TILE:'B'][CREATURE_CLASS:SIZE_TITANIC][CREATURE_CLASS:BIOMACHINE_SIZE_TITANIC]
	...
	[BP_APPEARANCE_MODIFIER:DENSE:0:70:90:100:110:130:200]
		[APP_MOD_IMPORTANCE:10000]
            ...
            {     
                body_token = "", 
                desc_part = "form-fitting hyper-alloy dermal plating grows melded to its body, growing denser at the extremities. ",
